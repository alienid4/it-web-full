  ...
  function renderTopology(data) {
    ...
    const options = {
      ...
      layout: {
        hierarchical: {
          enabled: true,
          direction: "LR",          // 上游 → 下游 從左到右
          sortMethod: "directed",   // 依箭頭方向排
          levelSeparation: 220,
          nodeSpacing: 130,
          treeSpacing: 200,
          shakeTowards: "leaves",
    ...
    setMeta("節點數 " + (meta.node_count || visNodes.length) + " / 邊數 " + (meta.edge_count || visEdges.length) +
