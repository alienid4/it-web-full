...
def scan_subnet():
    ...
    # v3.17.18.0: OS detection via SSH banner + open ports
    def _probe_os(ip):
        """Probe OS by SSH banner + port heuristics. Returns (os_hint, os_group)."""
        # 1. Try SSH banner grab (port 22) - most informative
        try:
            ...
            if banner.startswith("SSH-"):
                ...
                # Generic SSH (banner doesn't reveal distro)
                return ("Linux/Unix", "linux")
        except Exception:
            pass
        # 2. Try Windows RDP (port 3389)
        try:
            ...
            pass
        # 3. Try SMB (port 445) - usually Windows
        try:
            ...
            pass
        # 4. Try Telnet (port 23) - often AS/400
        try:
