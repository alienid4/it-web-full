...
def add_security_headers(response):
    ...
    response.headers["Content-Security-Policy"] = "default-src 'self' 'unsafe-inline' 'unsafe-eval' https://fonts.googleapis.com https://fonts.gstatic.com https://cdn.jsdelivr.net https://static.cloudflareinsights.com; img-src 'self' data: https:; connect-src 'self' https://cloudflareinsights.com"
